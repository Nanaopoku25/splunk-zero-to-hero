# Splunk Security Project, This cover data ingestion for security dataset, normalizing the dataset, creating advanced visualizations and Creating Security Dashboards and some advanced splunk topics:)
